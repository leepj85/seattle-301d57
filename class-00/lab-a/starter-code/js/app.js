...
function displayPics(){
  ...
  // rando is declared within the first while loop, so if the declaration is set to const, it is scoped to the first while loop and is //not accessible to the inner while loop.
  console.log(viewed);
